<template>
  <div>
    ...
    <el-table :data="tableData" border stripe>
      ...
      <el-table-column label="工号" min-width="150" prop="jobNumber"></el-table-column>
      <el-table-column label="电话" min-width="150" prop="mobile"></el-table-column>
      <el-table-column label="邮箱" min-width="150" prop="email"></el-table-column>
      <el-table-column label="部门" min-width="150" prop="department"></el-table-column>
